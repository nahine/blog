<div class="reply-card p-3 mb-2">
    <div class="d-flex justify-content-between align-items-start">
        <div class="d-flex gap-2">
            <div class="avatar sm">{{ strtoupper(mb_substr($reply->user->name, 0, 1)) }}</div>
            <div>
                <strong class="d-block" style="color: var(--ink-900);">{{ $reply->user->name }}</strong>
    ...
    <p class="mb-0 mt-2 ms-1">{{ $reply->body }}</p>
</div>
